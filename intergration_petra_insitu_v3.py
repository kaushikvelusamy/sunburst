...
compound         = "cono32"
dataset          = "cono32_20v_2s_6_00001"                      # "feno33_1_26v_2s_1_00001" or "cuno32_20v_2s_4_00002"
...
def get_image_series(opendir=import_directory, list_all=False, start_ind=0, end_ind=30000):
    ...
    get_images = sorted(glob.glob(opendir +"*.tif"))            #genarates list of .tifs in import_directory
    if list_all:
...
def do_integration(ponifile, numbins , savedir, savexy, txtfile):
    ...
    if txtfile:
        ...
        plt.show()
        plt.savefig("waterfall.png", pad_inches=0.1)

do_integration(ponifile, numbins, export_directory, savexy, txtfile)
